...
class files_view{
	...
	protected function say_hello($view){
		  ...
		  if($this->cache){
			  ...
			  cls_page::show_block(false,  _('Tittle of message') , $this->cache, $view);
		  }
		  else{
		  ...
		  cls_page::show_block(false,  _('Tittle of message') , $this->raintpl->draw( 'hello_world_template', true ), $view);
		  }
