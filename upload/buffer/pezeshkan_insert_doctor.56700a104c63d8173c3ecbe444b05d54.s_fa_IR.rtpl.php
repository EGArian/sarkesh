<div id="pezeshkan_insert_doctor" class="pezeshkan_insert_doctor." >
	...
	<form>
		<div class="form-group pezeshkan_insert_doctor.">
			<label for="pezeshkan_doctor_name"> Doctor name: </label>
			<input type="text" id="pezeshkan_doctor_name" class="form-control" name="pezeshkan_doctor_name" placeholder=" Doctor name" onblur="">
			<label for="pezeshkan_doctor_specialty"> Specialty: </label>
			<input type="text" id="pezeshkan_doctor_specialty" class="form-control" name="pezeshkan_doctor_specialty" placeholder=" Specialty" onblur="">
			...
			<br>
			<button type="button" class="btn btn-primary" data-loading-text="Loading..." onclick="" >Save</button>
